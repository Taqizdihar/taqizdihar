        ...
        <section>
          <div className="relative bg-white/90 dark:bg-[#A81717] backdrop-blur-md rounded-2xl md:rounded-3xl border border-maroon-900/10 dark:border-white/10 shadow-xl overflow-hidden group flex flex-col md:flex-row min-h-[400px]">
            ...
            <div className="relative w-full md:w-1/2 h-64 md:h-auto overflow-hidden">
              ...
              <div className="hidden md:block absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-[#ffffff] dark:from-[#7f1d1d] to-transparent"></div>
              {/* Gradient mask for mobile */}
              <div className="md:hidden absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-white dark:from-red-900/90 to-transparent"></div>
            </div>
            ...
            <div className="relative w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center dark:bg-transparent">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-maroon-900 dark:text-white transition-colors mb-4 leading-tight">
                {productPromo.title}
              </h2>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#EE4D2D] hover:bg-[#D74226] text-white px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-lg hover:shadow-[#EE4D2D]/40 group/btn w-full sm:w-auto"
              >
