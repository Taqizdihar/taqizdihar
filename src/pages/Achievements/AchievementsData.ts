export const achievements = [
  {
    ...
    issuerLogo: "/assets/logo/Oracle Academy.png",
    logoDescription: "Oracle Academy Logo",
    ...
    media: [
      { type: "image", url: "/assets/achievements/Oracle Certificate.jpg", description: "Oracle Academy SQL Award of Completion certificate" },
      { type: "image", url: "/assets/achievements/LMS SQL Award.jpg", description: "LMS SQL Award completion screenshot" }
    ]
  },
  {
    id: 2,
